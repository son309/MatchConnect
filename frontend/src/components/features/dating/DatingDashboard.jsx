      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/75 via-black/20 to-transparent p-5 text-white">
          <div className="flex flex-wrap items-center gap-2">
            ...
            {isProfileVerified && (
              <span className="inline-flex items-center gap-1 rounded-full bg-emerald-500/95 px-2.5 py-1 text-xs font-bold text-white shadow-sm" title="Verified profile">
                <ShieldCheck size={14} />
                Verified
              </span>
            )}
